...
const GAMES = [
  ...
  },
  {
    ...
    events: [`Youth Group`, `Christmas Party`, `Sunday School`, ],
    settings: [`Organized`, ],
  },
  {
    id: 39,
...
/*   {
  ...
  },
  {
    ...
    name: `Human Knot`,
    spaces: [`Indoors`, `Outdoors`, ],
    description: `Form groups of about 10 people each. Have each group stand facing each other shoulder to shoulder in a circle. First, have everyone stick their left hand out into the circle. Then have them grab someone else's left hand with their right hand. Make sure that no one is holding hands with the person directly next to them, and that they aren't holding both hands with the same person. To play, the groups must communicate and figure out how to untangle the knot (forming a circle of people) without ever letting go of any hands.`,
  ...
  },
  {
    ...
    name: `Musical Chairs`,
    spaces: [`Indoors`, ],
    description: `Create a circle of chairs facing outwards. There should be a few less chairs than the number of people playing. Have players walk in a circle around the chairs while music plays. Players may not "hover" above a chair until the next one "opens up", but must continue walking at all times. When the game leader pauses the music, everyone must sit down in a chair. Anyone who can't find a chair is eliminated. Remove a few chairs after the round and repeat until there is only one player left.`,
    events: [`Sunday School`, `Christmas Party`, ],
    settings: [`Organized`, ],
  },
  {
    id: 71,
