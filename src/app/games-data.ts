...
const games: Game[] = [
  ...
  },
  {
    ...
    spaces: [`Outdoors`, ],
    description: `Classic Glenwood night game. Split the students into 2-4 teams. Each team is assigned a different color of flaging tape, and each team member will have a small length tied onto their wrist so that it is visible. Hidden somewhere on the property, a leader will be waiting to collect the tape from the students. The student's goal is to find this leader and give him/her their wristband. If they suceed, they may return to the starting point, and get another wristband and attempt to find the leader again. The catch is that the other leaders will be roaming and sneaking around, trying to catch the students before they make it to the designated leader. These leaders catch the students by shining their flashlight on them. The leader can then take the students’ wristbands or they can make them do something silly like sing Justin Bieber at the top of their lungs as "payment" and then let them go free. Coming up with creative "payments" is highly encouraged. If the leader is not feeling generous and takes the student’s wristband, then the student can go back to base where the another leader will give them another wristband. Only one wristband per student at a time. Glowsticks can be hidden throughout the playing area. If a player finds it and delivers it to the designated leader, they earn X number of points for their team. Glowsticks should be carried in the open, not stuffed in to a pocket or under a shirt, making it harder for students to be sneaky. At the end of the time, all the lengths of tape and glowsticks successfully delivered are counted up and the team with the most points wins.`,
  ...
  },
  {
    ...
    spaces: [`Indoors`, ],
    description: `Groups of 10-20 players form circles and choose one start person. That person will turn to the person on their right and ask a question (yes or no questions do not work). The person who they asked must respond with “My grandmother’s big fat toe”. The person who answered will then turn to the person on their right and ask a new question, to which the person asked must respond “My grandmother’s big fat toe” and so on. The trick is that you cannot smile or laugh while asking, answering, or being asked a question. If someone laughs they are out and must sit down or back out of the circle. If someone repeats a question that has already been asked they are out. Players must make eye contact when asking or answering a question. If someone hesitates in answering they are out. Last player standing wins. Game Twist: If players are too good at not laughing, up the bar to not smiling.`,
    events: [`Sunday School`, ],
    settings: [`Organized`, ],
  },
  {
  ...
  },
  {
    ...
    name: `Link Tag`,
    spaces: [`Indoors`, `Outdoors`, ],
    description: `Players choose a partner and link arms. The pairs then space out and stand in a large circle. One set of players is chosen to start. One is “it” and chases the other player in a tag-like fashion. The player being chased may choose to link up with any pair standing around the circle. When they link up with someone, the person who is already linked to that person must break off and the “it” must now chase them. If the “it” tags the person they are pursuing, play reverses and the person tagged is now “it” and the other is now running away. Once the group has the basics down, more pairs can be released to chase. Game Twist: Have players get into groups of three and have pairs stay linked while chasing/running. When pair links up with a group of three, the end two break off and remain linked to each other while running.`,
    events: [`Youth Group`, ],
    settings: [`Organized`, ],
  },
  {
  ...
  },
  {
    ...
    name: `Cheetoh Toss`,
    spaces: [`Outdoors`, ],
    description: `Split group into two teams and have them line up in single file lines. Have a volunteer from each team stand a little in front of the line and cover their face with whip cream. The teams then work through the line, each player throwing a cheeto and trying to make it stick to their team mates face. The winning team is the one that gets the most to stick.`,
    events: [`Summer Camp`, ],
    settings: [`Organized`, ],
  },
  {
